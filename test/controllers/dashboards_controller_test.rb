...
class DashboardsControllerTest < ActionController::TestCase
  ...
  test "should create dashboard" do
    assert_difference('Dashboard.count') do
      post :create, dashboard: { description: @dashboard.description, isactive: @dashboard.isactive, name: @dashboard.name, url: @dashboard.url }
    end
  ...
  test "should update dashboard" do
    patch :update, id: @dashboard, dashboard: { description: @dashboard.description, isactive: @dashboard.isactive, name: @dashboard.name, url: @dashboard.url }
    assert_redirected_to dashboard_path(assigns(:dashboard))
  end
